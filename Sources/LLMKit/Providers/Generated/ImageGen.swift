...
struct ImageModelDef: Sendable, Equatable {
    let modelId: String
    let label: String
...
struct ImageGenDef: Sendable, Equatable {
    ...
    let models: [ImageModelDef]
}

func imageGenConfig(_ provider: ProviderName) -> ImageGenDef? {
    switch provider {
    case .google:
        return ImageGenDef(
