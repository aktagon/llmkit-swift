...
/// wire shape to a typed ParsedModelsPage over the hand-rolled JSONValue waist.
/// Capability enrichment from the ontology lives in Models.swift — these
...
/// Structured decode error. `provider` names the parser (anthropic /
/// openai-cohort / google); `reason` carries the underlying JSON message.
...
/// unparseable input (the silent-failure contract: a bad timestamp does not
